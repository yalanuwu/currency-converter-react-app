...
function App() {
  ...
  return (
    ...
    style={{ backgroundImage: `url(https://images.unsplash.com/photo-1654089670624-0db58288cd01?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)` }}>
        ...
        <div className='w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/40 '>
          <form action="" onSubmit={(e) => {
            ...
            <div className='w-full mb-1'>
              <InputBox
                label = "from" amount= {amount} currencyOption={options}
            ...
            <div className='w-full mb-1'>
              <InputBox
                label = "to" amount= {convertedAmount} currencyOption={options}
                amountDisabled
                onCurrencyChange = {(currency) => {
                  setTo(currency)
                }}
